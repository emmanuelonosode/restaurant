...
export const metadata: Metadata = {
  title: "The Journal",
  description: "Stories, forgotten techniques, and the evolution of West African gastronomy. Recipes, chef's specials, and culinary history from The Culinary Gallery.",
  keywords: ["nigerian food blog", "west african recipes", "jollof rice recipe", "suya recipe", "nigerian cooking", "culinary journal"],
  openGraph: {
    title: "The Journal | The Culinary Gallery",
    description: "Curated stories, forgotten techniques, and the evolution of West African gastronomy.",
    type: "website",
    images: [{ url: "https://images.unsplash.com/photo-1600891964092-4316c288032e?q=80&w=2000", alt: "Traditional Nigerian clay pot with jollof rice" }],
  },
};
    ...
    <>
      <main className="pt-32 pb-24">
        ...
        <header className="max-w-7xl mx-auto px-8 mb-24">
          ...
          {/* Category Filter */}
          <div className="mt-16 flex flex-wrap gap-4 border-t border-outline-variant/30 pt-8" role="group" aria-label="Filter by category">
        ...
        <section className="max-w-7xl mx-auto px-8 mb-32">
          <article className="group relative grid grid-cols-1 md:grid-cols-12 gap-0 md:gap-16 items-center">
            <div className="md:col-span-7 overflow-hidden rounded-xl bg-surface-container shadow-sm">
              <img className="w-full h-[600px] object-cover group-hover:scale-105 transition-transform duration-700 ease-out" alt="Rich red smoky Jollof rice in a traditional clay pot with aromatic steam" src="https://images.unsplash.com/photo-1600891964092-4316c288032e?q=80&w=1500&auto=format&fit=crop"/>
            </div>
            <div className="md:col-span-5 py-12 md:py-0 -mt-16 md:mt-0 relative z-10">
              <div className="bg-background/90 backdrop-blur-sm p-8 md:p-0">
                ...
                <Link className="inline-flex items-center gap-2 text-primary font-label font-bold text-sm group/link" href="/journal/smokey-jollof">
                  READ THE STORY
        ...
        <section className="max-w-7xl mx-auto px-8 mb-32">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-16">
            ...
            <article className="group">
              ...
              <Link className="text-primary font-label font-bold text-xs tracking-widest border-b border-primary/20 pb-1 hover:border-primary transition-colors" href="/journal/hibiscus-suya">READ MORE</Link>
            </article>
            ...
            <article className="group">
              ...
              <Link className="text-primary font-label font-bold text-xs tracking-widest border-b border-primary/20 pb-1 hover:border-primary transition-colors" href="/journal/seafood-okra">READ MORE</Link>
            </article>
            ...
            <article className="group">
              ...
              <Link className="text-primary font-label font-bold text-xs tracking-widest border-b border-primary/20 pb-1 hover:border-primary transition-colors" href="/journal/plantain-gnocchi">READ MORE</Link>
            </article>
          </div>
        </section>

        {/* Newsletter Signup Section */}
        <section id="newsletter" className="max-w-7xl mx-auto px-8 mb-12">
          <div className="bg-primary-container rounded-xl p-12 md:p-24 relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-2xl mx-auto text-center">
              ...
              <form className="flex flex-col md:flex-row gap-4" action="mailto:curate@culinarygallery.ng" method="GET">
                <label htmlFor="newsletter-email" className="sr-only">Email address</label>
                <input
                  id="newsletter-email"
                  className="flex-grow bg-transparent border-b border-on-primary-container/30 text-on-primary-container placeholder:text-on-primary-container/50 px-4 py-3 focus:outline-none focus:border-secondary transition-colors font-body"
