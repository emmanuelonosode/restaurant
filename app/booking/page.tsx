          ...
          <div className="lg:col-span-7 bg-surface-container-lowest p-12 rounded-xl shadow-sm border border-surface-variant/20">
            <form className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-10">
              <div className="col-span-1">
                <label className="block text-xs font-label uppercase tracking-widest text-secondary font-bold mb-2">Name</label>
                <input className="w-full bg-transparent border-0 border-b border-outline-variant focus:border-secondary focus:ring-0 px-0 py-2 font-body text-sm outline-none transition-colors" placeholder="Your full name" type="text"/>
              </div>
              <div className="col-span-1">
                <label className="block text-xs font-label uppercase tracking-widest text-secondary font-bold mb-2">Email Address</label>
                <input className="w-full bg-transparent border-0 border-b border-outline-variant focus:border-secondary focus:ring-0 px-0 py-2 font-body text-sm outline-none transition-colors" placeholder="email@example.com" type="email"/>
              </div>
              <div className="col-span-1">
                <label className="block text-xs font-label uppercase tracking-widest text-secondary font-bold mb-2">Event Date</label>
                <input className="w-full bg-transparent border-0 border-b border-outline-variant focus:border-secondary focus:ring-0 px-0 py-2 font-body text-sm outline-none transition-colors text-stone-500" type="date"/>
              </div>
              <div className="col-span-1">
                <label className="block text-xs font-label uppercase tracking-widest text-secondary font-bold mb-2">Event Type</label>
                <select className="w-full bg-transparent border-0 border-b border-outline-variant focus:border-secondary focus:ring-0 px-0 py-2 font-body text-sm outline-none transition-colors appearance-none text-stone-500">
              ...
              <div className="col-span-1">
                <label className="block text-xs font-label uppercase tracking-widest text-secondary font-bold mb-2">Guest Count</label>
                <input className="w-full bg-transparent border-0 border-b border-outline-variant focus:border-secondary focus:ring-0 px-0 py-2 font-body text-sm outline-none transition-colors" placeholder="Number of guests" type="number"/>
              </div>
              <div className="col-span-1">
                <label className="block text-xs font-label uppercase tracking-widest text-secondary font-bold mb-2">Budget Range (USD)</label>
                <input className="w-full bg-transparent border-0 border-b border-outline-variant focus:border-secondary focus:ring-0 px-0 py-2 font-body text-sm outline-none transition-colors" placeholder="$1,000 - $5,000" type="text"/>
              </div>
              <div className="col-span-full">
                <label className="block text-xs font-label uppercase tracking-widest text-secondary font-bold mb-2">Special Requests & Vision</label>
                <textarea className="w-full bg-transparent border-0 border-b border-outline-variant focus:border-secondary focus:ring-0 px-0 py-2 font-body text-sm outline-none transition-colors resize-none" placeholder="Tell us about the occasion and any dietary preferences..." rows={4}></textarea>
              </div>
              <div className="col-span-full pt-6">
                <button className="w-full bg-primary text-on-primary py-4 rounded-full font-label font-bold uppercase tracking-[0.2em] text-xs hover:bg-primary-container transition-colors shadow-lg active:scale-95 transition-all" type="submit">
                  Submit Inquiry
                </button>
              </div>
            </form>
